...
urlpatterns = [
    ...
    url(r'^wydarzenie/dodaj/$', EventCreateView.as_view(), name="event_details_create"),
    url(r'^wydarzenie/(?P<pk>\d+)/edycja/$', EventUpdateView.as_view(), name="event_details_update"),
